...
set CLASSPATH=%APP_HOME%\lib\jpaDemo1.jar;%APP_HOME%\lib\hibernate-core-5.3.2.Final.jar;%APP_HOME%\lib\postgresql-42.2.2.jar;%APP_HOME%\lib\hibernate-jpa-2.1-api-1.0.2.jar;%APP_HOME%\lib\gretty-2.0.0.jar;%APP_HOME%\lib\jstl-1.2.jar;%APP_HOME%\lib\javax.servlet-api-3.1.0.jar;%APP_HOME%\lib\hibernate-commons-annotations-5.0.4.Final.jar;%APP_HOME%\lib\jboss-logging-3.3.2.Final.jar;%APP_HOME%\lib\javax.persistence-api-2.2.jar;%APP_HOME%\lib\javassist-3.22.0-GA.jar;%APP_HOME%\lib\byte-buddy-1.8.12.jar;%APP_HOME%\lib\antlr-2.7.7.jar;%APP_HOME%\lib\jboss-transaction-api_1.2_spec-1.1.1.Final.jar;%APP_HOME%\lib\jandex-2.0.5.Final.jar;%APP_HOME%\lib\classmate-1.3.4.jar;%APP_HOME%\lib\javax.activation-api-1.2.0.jar;%APP_HOME%\lib\dom4j-1.6.1.jar;%APP_HOME%\lib\gretty-core-2.0.0.jar;%APP_HOME%\lib\spring-boot-loader-tools-1.5.4.RELEASE.jar;%APP_HOME%\lib\jetty-util-8.1.8.v20121106.jar;%APP_HOME%\lib\groovy-json-2.4.11.jar;%APP_HOME%\lib\groovy-2.4.11.jar;%APP_HOME%\lib\commons-cli-1.2.jar;%APP_HOME%\lib\commons-configuration-1.10.jar;%APP_HOME%\lib\commons-io-2.4.jar;%APP_HOME%\lib\commons-lang3-3.3.2.jar;%APP_HOME%\lib\org.apache.servicemix.bundles.bcprov-jdk16-1.46_3.jar;%APP_HOME%\lib\spring-boot-devtools-1.3.3.RELEASE.jar;%APP_HOME%\lib\spring-boot-autoconfigure-1.3.3.RELEASE.jar;%APP_HOME%\lib\spring-boot-1.3.3.RELEASE.jar;%APP_HOME%\lib\spring-context-4.2.5.RELEASE.jar;%APP_HOME%\lib\spring-aop-4.2.5.RELEASE.jar;%APP_HOME%\lib\spring-beans-4.2.5.RELEASE.jar;%APP_HOME%\lib\spring-expression-4.2.5.RELEASE.jar;%APP_HOME%\lib\spring-core-4.3.9.RELEASE.jar;%APP_HOME%\lib\commons-lang-2.6.jar;%APP_HOME%\lib\commons-logging-1.2.jar;%APP_HOME%\lib\aopalliance-1.0.jar
